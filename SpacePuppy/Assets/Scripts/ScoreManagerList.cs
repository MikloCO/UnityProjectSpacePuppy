...
//	void Start()
//	{
//		dataController = FindObjectOfType();                                // Store a reference to the DataController so we can request the data we need for this round
...
//			AnswerButton answerButton = answerButtonGameObject.GetComponent();
